...
highlight PdbCurrentLine guibg=DarkGreen ctermbg=DarkGreen
highlight PdbBreakpoint guibg=DarkRed ctermbg=DarkRed
highlight PdbConditionalBreakpoint guibg=Purple ctermbg=DarkBlue
highlight PdbTemporaryBreakpoint guibg=SlateBlue ctermbg=Blue
